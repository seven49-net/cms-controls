seven49cms.renderBxContentSlider = function(json, params) {
	var options = $.extend({
		...
		imgClass: "img",
		textClass: "text",
		cssPath: "//cdn.seven49.net/common/js/jquery/plugins/bxslider/jquery.bxslider.css",
		jsPath: "//cdn.seven49.net/common/js/jquery/plugins/bxslider/jquery.bxslider.min.js",
